...
public static class SunriseSunset
{
    ...
    public static DayTimesResult GetUTC(int year, int month, int day, double lat, double lng)
    {
        return Get(year, month, day, lng, lat, SunriseSunsetAltitude, true);
    }
    ...
    /// <param name="d"></param>
    /// <returns></returns>
    private static long DaysSince2000(int y, int m, int d)
    {
    ...
    /// </returns>
    private static DayTimesResult Get(int year, int month, int day, double lon, double lat,
                     double altit, bool upper_limb)
    {
        ...
        SunRADec(d, out double sRA /* Sun's Right Ascension */,
            out double sdec /* Sun's declination */,
            out double sr /* Solar distance, astronomical units */);
        ...
        {
            Sunrise = TimeSpan.FromHours(trise),
            Sunset = TimeSpan.FromHours(tset)
        };
    }
    ...
    /// <param name="lon"></param>
    /// <param name="r"></param>
    private static void SunPosition(double d, out double lon, out double r)
    {
    ...
    private static void SunRADec(double d, out double RA, out double dec, out double r)
    {
        ...
        SunPosition(d, out double lon, out r);
